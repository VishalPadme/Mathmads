...
function fib()
{
    ...
    var c;
    if (n !=""&&n>=0)
    {document.getElementById("ans").innerHTML=" "+"fibonacci Series Till "+n+":<br>";}
    else{document.getElementById("ans").innerHTML="Please Enter Valid Input";}
    for(var i=0;i<n;i++)
        {
    if (i==0)
    {document.getElementById("ans").innerHTML+="";c=0;}
    else if(i==1)
    ...
    if (n !=""&&n>=0)
    {document.getElementById("ans").innerHTML+="<br><br>"+n+" th Element Of Series f("+(n-1)+"): "+c;}
...
var rev=0,dig=0,tmp=0,pc;
 ...
 while (n>0)
    ...
    if (tmp !="")
    {document.getElementById("ans").innerHTML="The Reversed Number Of "+tmp+": "+rev+"<br>";}
...
if (tmp !="")    
{document.getElementById("ans").innerHTML+=tmp+" Is "+pc;}
